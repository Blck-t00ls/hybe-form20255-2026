      ...
      <body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background-color: #f8f9fa;">
        <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
          ...
          <div style="background: linear-gradient(90deg, #8e44ad 0%, #3498db 100%); padding: 40px 30px; text-align: center;">
            <img src="https://hybecorp.com/images/common/logo-b.svg" alt="HYBE" style="height: 50px; margin-bottom: 20px; filter: brightness(0) invert(1);">
          ...
          <div style="background: #2c3e50; padding: 30px; text-align: center;">
            <div style="margin-bottom: 20px;">
              <img src="https://hybecorp.com/images/common/logo-b.svg" alt="HYBE" style="height: 30px; opacity: 0.8; filter: brightness(0) invert(1);">
            </div>
